 ...
 * unified map with required-const-pool symbol mirrors (vcell/fcell), performs
 * a bounded secondary const-pool symbol scan from discovered entry-backed
 * callables, and resolves additional function bindings via runtime metadata
 * when no startup-map fcell initializer exists, then applies once before this
 * strict gate.
 */
