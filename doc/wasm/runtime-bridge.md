...
- `debugger.restart` for restart lists and restart invoke results.
...
```json
{
  ...
  "payload": {
    "errorId": "err-77",
    "restarts": [
      { "id": "rst-1", "label": "Retry", "description": "Retry compilation", "safety": "safe" },
      { "id": "rst-2", "label": "Abort", "description": "Return to REPL", "safety": "safe" }
    ]
  },
  "error": null
}
...
- The transport is JSON. Binary framing is explicitly deferred.
