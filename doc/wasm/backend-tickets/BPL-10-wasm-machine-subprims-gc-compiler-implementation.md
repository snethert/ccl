...
- Why now: latest `B10C-01A-17` evidence still shows above-budget direct-lane latency (`+4.067 ns/op`, `+9.631%`) even after prologue/epilogue overhead reduction, so redline promotion rule `#3` continues to block phase advance.
