...
- Why now: latest `B10C-01A-17` evidence still shows above-budget direct-lane latency (`+3.716 ns/op`, `+8.898%`) even after further prologue operand-staging tightening, so redline promotion rule `#3` continues to block phase advance.
