...
- Action: advance from shift-path hardening into spill-discipline refinement.
- `1.` start `B10C-01A-13` by refining `compiler/WASM/wasm2.lisp` spill discipline so direct primitive lanes only enter spill/call envelopes when they actually branch to helper/subprim fallbacks.
- `2.` continue strict hot-math order through `B10C-01A-14`..`B10C-01A-17` with per-slice rebuild + strict audit + smoke evidence.
...
- Why now: `B10C-01A-04`/`A-05`, `B10C-01A-08`, `B10C-01A-09`, `B10C-01A-10`, `B10C-01A-11`, and `B10C-01A-12` are now closed with required validation evidence, so hot-lane migration can continue into spill-discipline refinement and compat-lane narrowing.
