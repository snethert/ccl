...
- Why now: latest `B10C-01A-17` evidence still shows above-budget direct-lane latency (`+2.793 ns/op`, `+6.497%`) even after further epilogue overhead reduction, so redline promotion rule `#3` continues to block phase advance.
