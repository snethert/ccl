...
- Action: advance from subprim-boundary tightening into checkpoint evidence capture.
- `1.` start `B10C-01A-17` by capturing fixnum hot-lane before/after latency + instruction-path deltas after `B10C-01A-15` boundary tightening.
...
- `3.` after hot-math checkpoint closure, proceed to high-impact object lanes (`B10C-01A-18`..`B10C-01A-22`), medium-impact call/control lanes (`B10C-01A-23`..`B10C-01A-25`), and promotion gates (`B10C-01A-26`..`B10C-01A-27`).
- Why now: `B10C-01A-04`/`A-05`, `B10C-01A-08`, `B10C-01A-09`, `B10C-01A-10`, `B10C-01A-11`, `B10C-01A-12`, `B10C-01A-13`, `B10C-01A-14`, and `B10C-01A-15` are now closed with required validation evidence, so promotion focus moves to measured checkpoint evidence before high/medium lane migration.
- Success evidence: compatibility-subprim boundaries stay explicit and bounded, required validation remains green per slice, and perf checkpoint artifacts are attached before next-lane promotion.
