...
- Action: advance from spill-discipline refinement into compat-lane narrowing.
- `1.` start `B10C-01A-14` by marking `wasm_return_fixnum_*` as compatibility helpers only and removing any remaining hot-lane compiler dependence on them.
- `2.` continue strict hot-math order through `B10C-01A-15`..`B10C-01A-17` with per-slice rebuild + strict audit + smoke evidence.
...
- Why now: `B10C-01A-04`/`A-05`, `B10C-01A-08`, `B10C-01A-09`, `B10C-01A-10`, `B10C-01A-11`, `B10C-01A-12`, and `B10C-01A-13` are now closed with required validation evidence, so hot-lane migration can continue into compat-lane narrowing and subprim-boundary tightening.
