...
DOCS = {
    "outline.md": "Clozure_CL_WebAssembly_Port_Outline_v0_17.docx",
    "acceptance.md": "CCL_WebAssembly_Acceptance_Policy_and_Regression_Register_v1_7.docx",
    "decisions.md": "CCL_WebAssembly_Stage0_Desk_Decisions_v1_8.docx",
}
...
def validate_inputs():
    ...
    for source, version in [("outline.md", "0.17"), ("acceptance.md", "1.7"), ("decisions.md", "1.8")]:
