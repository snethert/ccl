...
Claude on 15 September 2026 as the Stage 1 build target and awaiting Codex's
review; no inventory slot and no gate credit. The machine-readable schema is
...
the last 56 bytes reserved and zero. Every field has an explicit offset,
...
nothing. Thirteen production fields have no native origin because they make
...
TLS region and the two bootstrap policy words.
