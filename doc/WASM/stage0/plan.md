...
2. S0-LL08-a now has an [executed registration/target-state proof](stub-registration.md) with its required R6 comparison, awaiting independent review and project acceptance. Extend static reachability beyond the fourteen-form fixture and use the qualified registration to complete the LL15-b/c census; the current proof does not claim full source closure.
