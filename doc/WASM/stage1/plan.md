...
LL21-b now proposes one generated function per module under benchmark policy v3, with complete code-ID/entry maps, measured load costs and retained-code growth. The [qualification](../../../tests/wasm/stage1/granularity/README.md) preserves three old/new generations and closures in late Workers. It awaits independent review and acceptance; no merged ranking or complete bootstrap latency is claimed. Next is S1-LL09-a generated symbol/package work, followed by initialization and final bootstrap membership before LL14.
