...
The test driver reports upstream-disabled tests explicitly and does not redefine their exclusions. A missing, unexpected or failing eligible test fails execution. Raw FASL differences remain unexplained until characterized; passing behavioral tests alone cannot establish repeatability. Native execution, same-host repeatability and acceptance review remain separate claims. The user [retired the second-Mac requirement](../../../doc/WASM/stage0/second-mac-decision.md) on 2026-09-13; this runner claims no cross-host reproduction.
