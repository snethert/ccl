...
Run `python3 tests/wasm/stage1/stream-constructor-acceptance/check.py` at this
integration commit. It binds the audit, acceptance, proposal qualification and
integrated sources. Later product changes require their own qualification; this
is an historical integration identity check, not a claim about arbitrary HEADs.
