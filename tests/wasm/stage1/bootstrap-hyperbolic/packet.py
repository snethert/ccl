...
def main():
    ...
    if args.mode=='retain':
        ...
        subprocess.run([sys.executable,HERE/'readers.py',EVIDENCE,environment/'proposal/files',numeric/'readers'],check=True)
