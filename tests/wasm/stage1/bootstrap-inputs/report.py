...
def report(out):
    ...
    baseline=Path(__file__).resolve().parents[5]/'ccl-evidence/2026-09-21-stage1-bootstrap-carry-r1/execution/execution-frontier.json'
    ...
    save('progress.json',dict(baseline_executed=301,executed=len(executed),new_executions=sorted(executed-set(before['names'])),
        ...
        reader_files_complete_before=38,reader_files_complete_after=39,
