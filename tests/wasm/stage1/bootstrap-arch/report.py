...
NUMERIC={'l0-numbers','l0-float','l0-bignum32'}
...
def report(out):
    ...
    with tarfile.open(ROOT.parent/'ccl-evidence/2026-09-22-stage1-bootstrap-file-environments-r1/artifacts.tar.gz') as archive:
