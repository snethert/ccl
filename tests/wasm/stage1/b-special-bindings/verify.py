...
def verify(packet,evidence):
 ...
 temp=Path(tempfile.mkdtemp(prefix='ccl-special-verify-')).resolve()
 try:
 ...
 print('S1-B-SPECIAL-BINDINGS-VERIFIED: native R6/R6a, generated dynamic bindings and unwind restoration, native comparisons, mutants, lazy composition and refusals')
