...
def verify(packet,evidence):
 require((HERE/'wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0]==(HERE.parent/'b-closures/wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0],'REVIEWED_NON_B_ENTRIES_UNCHANGED')
 ...
 print('S1-B-LOCAL-CALLS-VERIFIED: native R6/R6a, local calls, independent root counts and refusals')
