...
def cases():
 ...
 for name in ('local_apply_literal','local_apply_function_literal'):
  for v in ('nil','t',7,'n1'):add(name,[37,'n0'],[[v,'nil'],[11,13]],closure_bytes=40)
 ...
 add('local_literal_apply_order',['n0'],[[3,5]],closure_bytes=40)
 add('local_apply_variable',[37],closure_bytes=40)
 add('local_apply_parameter',[37],closure_bytes=40)
 for name in ('local_apply_literal','local_apply_function_literal'):
  add(name,[37,'nil'],closure_bytes=40)
  add(name,[37,'n0'],chain([11,13]),closure_bytes=40)
 return out
