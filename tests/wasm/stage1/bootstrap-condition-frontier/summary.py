...
def summarize(out):
 ...
 with tarfile.open(ROOT.parent/'ccl-evidence/2026-09-22-stage1-bootstrap-introspection-r1/artifacts.tar.gz') as a:previous=names(json.load(a.extractfile('numeric/compiled/native.json')))
