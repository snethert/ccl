...
const observations=[];let resultChecks=0;
...
parentPort.postMessage({status:'PASS',modules:mods.length,comparisons:observations.length,ownership_inspections:checks,peak_root_frames:peakRoots,cases:observations,resource_refusals:60,result_capacity_checks:resultChecks,allocation_boundary_checks:8});
}
