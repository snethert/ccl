...
def verify(packet,evidence):
 require((HERE/'wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0]==(HERE.parent/'b-calls/wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0],'REVIEWED_NON_B_ENTRIES_UNCHANGED')
 ...
 print('S1-B-BINDINGS-VERIFIED: native R6/R6a, optional and keyword binding, source refusals and compiler mutants')
