...
def report(out):
    ...
    baseline=Path(__file__).resolve().parents[5]/'ccl-evidence/2026-09-21-stage1-bootstrap-math-r2/execution/execution-frontier.json'
    ...
    save('progress.json',dict(baseline_executed=423,executed=len(executed),new_executions=sorted(executed-set(before['names'])),
