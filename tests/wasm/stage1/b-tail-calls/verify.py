...
def verify(packet,evidence):
 require((HERE/'wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0]==(HERE.parent/'b-local-calls/wasm32-backend.lisp').read_text().split(';;; First B call unit:')[0],'REVIEWED_NON_B_ENTRIES_UNCHANGED')
 ...
 print('S1-B-TAIL-CALLS-VERIFIED: native R6/R6a, bounded tail transfer, stack-temporary APPLY, mutants and refusals')
