...
def sources():
    ...
    parent = read(STORE / '2026-09-22-stage1-condition-cpl-r1/source-pins.json')
...
def main():
    ...
    dependency_names = (
        '2026-09-22-stage1-condition-cpl-r1/packet.json',
        '2026-09-22-stage1-condition-cpl-r1/execution.tar.gz',
        '2026-09-22-stage1-condition-cpl-acceptance/packet.json',
    ...
    if args.mode == 'retain':
        ...
        with tarfile.open(packet / 'development.tar.gz', 'w:gz') as archive:
            for name in ('ccl-condition-system-r11/spread-trace.log',
                         'ccl-condition-system-r11/initargs-trace.log',
                         'ccl-condition-system-r13/execution.log',
                         'ccl-condition-system-r16/regions.log',
                         'ccl-condition-system-r17/execution.log'):
                archive.add(Path('/tmp') / name, arcname=name, recursive=False)
        save(packet / 'packet.json', dict(id='STAGE1-CONDITION-SYSTEM-R1',
