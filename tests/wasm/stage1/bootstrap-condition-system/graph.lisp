                 ...
                 (loop for i from 1 below (length fields) do
                   ...
                   (when (or (not classp) (member i '(3 4 5 6))
                         (and (= (length root) 13) (or (subtypep (class-name object) 'condition)
                          (member (class-name object) '(class standard-class ccl::standard-effective-slot-definition ccl::slot-definition ccl::effective-slot-definition)))
                           (member i '(11 14 16))))
               ...
               (cond ((gethash object *condition-hash-vectors*)
                     ...
                     ((hash-table-p object)
                      (node 130 (vector (ccl::%svref object 0) nil 0 nil
                                        (ccl::nhash.vector object) nil nil nil nil nil nil nil nil nil t nil)))
