"""Bind the integrated files to audit 165's already-qualified proposal.

This is an identity check, not another execution run. The original verifier
replays from 78b187ba; its source pins intentionally precede integration.
"""
...
PACKET = '2026-09-23-stage1-class-growth-r1'
PACKET_SHA = '509d916f2255a6707c3779744240f7a025b6a4499ca45e69c4e52100659d05a1'
BACKEND = 'compiler/WASM32/wasm32-backend.lisp'
COMPILER_SHA = '569d6647eb1bd033006176c37afce89aa8fff2688e0e223007b44803c7b99bd5'
REVIEW = 'e113a663f81687f570b1090e39e37b5df88c5352'
...
def check(store):
    ...
    acceptance = read(ROOT / 'doc/WASM/stage1/acceptance-class-growth.json')
