...
def compile(e,out,code=None):
 out.mkdir(parents=True,exist_ok=False);h=out/'driver';shutil.copytree(C,h,ignore=shutil.ignore_patterns('__pycache__','review-followup'));shutil.copy(HERE/'compile.lisp',h/'compile.lisp')
