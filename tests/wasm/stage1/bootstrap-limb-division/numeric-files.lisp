...
(dolist (path '("ccl:level-0;l0-numbers.lisp" "ccl:level-0;l0-float.lisp" "ccl:level-1;l1-numbers.lisp" "ccl:level-1;l1-aprims.lisp" "ccl:level-1;l1-clos-boot.lisp" "ccl:level-1;l1-dcode.lisp"))
