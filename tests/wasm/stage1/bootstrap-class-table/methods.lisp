                                ...
                                when (and class (ccl::class-finalized-p class)
                                          (or (subtypep (class-name class) 'condition)
                                              (member (class-name class)
                                                '(class standard-class ccl::standard-effective-slot-definition
...
(defparameter *condition-system-callers*
  '(core-condition-table-store core-condition-new-cell core-condition-rebuild-cells core-condition-table-read-only core-condition-create core-condition-signal-string core-condition-signal-symbol
...
(defun condition-system-entry-p (name)
  (or (member name *condition-system-callers*)
      (eq name 'core-condition-prepare)
