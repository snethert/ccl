...
if(isMainThread){
  ...
  let integer,floating,integerCalls=0,floatCalls=0,fastChecks=0;
  ...
  parentPort.postMessage({signedZero,refusals,layout:{...layout,values:layoutValues},integerCalls,floatCalls,fastChecks,base,comparisons:rows.length,collections,internalCollections,rows,...gen.summary()});
}
