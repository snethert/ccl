...
def generate():
    ...
    prior=ROOT.parent/'ccl-evidence/2026-09-21-stage1-bootstrap-closure-r1/execution/compiled/proposal/files'/BACKEND
    assert result==prior.read_text(), 'recipe packet must not change the compiler'
    return result
