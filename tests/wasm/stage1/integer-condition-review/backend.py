...
def generate():
 ...
 s=replace(s,"'(list cons function simple-vector integer fixnum or)","(if *b-integer-service* '(list cons function simple-vector integer fixnum or number real truncate) '(list cons function simple-vector integer fixnum or))")
