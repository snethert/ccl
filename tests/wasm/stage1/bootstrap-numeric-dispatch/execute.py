...
def fixture(name):return h/name if (h/name).exists() else h.parent/'bootstrap-clos-accessors'/name if (h.parent/'bootstrap-clos-accessors'/name).exists() else prior/name
