"""Bind the integrated files to audit 162's already-qualified proposal.

This is an identity check, not another execution run. The original verifier
replays from acf71bd7; its source pins intentionally precede integration.
"""
...
PACKET = '2026-09-22-stage1-condition-cpl-r1'
PACKET_SHA = '7320a64ec43a86f0c1388dfa1308e4b58d1008373a965b151619abc60ecc279c'
BACKEND = 'compiler/WASM32/wasm32-backend.lisp'
COMPILER_SHA = '5983f0862c2307aa6c9ce48bc0389136aeb3bdd1efa1b7046da34fdd556a1fab'
REVIEW = 'a5be153a35a9a98cfe0a80ed097823260305738d'
...
def check(store):
    ...
    acceptance = read(ROOT / 'doc/WASM/stage1/acceptance-condition-cpl.json')
