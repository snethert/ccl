...
def verify(packet,evidence):
 ...
 temp=Path(tempfile.mkdtemp(prefix='ccl-catch-verify-')).resolve()
 try:
 ...
 print('S1-B-CATCH-THROW-VERIFIED: native R6/R6a, generated nonlocal exits and control records, native comparisons, mutants, lazy composition and refusals')
