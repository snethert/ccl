...
def verify(packet,evidence):
 ...
 temp=Path(tempfile.mkdtemp(prefix='ccl-unwind-verify-')).resolve()
 try:
 ...
 print('S1-B-UNWIND-PROTECT-VERIFIED: native R6/R6a, generated cleanup extents, native comparisons, mutants, lazy composition and refusals')
