...
ID='STAGE1-BOOTSTRAP-HEAP-CENSUS-R1'
SOURCES=['README.md','census.lisp','census.py','population-check.mjs','run.py','packet.py']
def pins():
 prior=read(ROOT.parent/'ccl-evidence/2026-09-20-stage1-bootstrap-tables-review-r1/source-pins.json')
 for n,h in prior.items():assert sha(ROOT/n)==h,n
 paths=[HERE/n for n in SOURCES]+[ROOT/n for n in ['level-0/l0-utils.lisp','lib/backtrace.lisp','library/lispequ.lisp','lib/method-combination.lisp']]
...
def inputs(e):
 return {n:sha(e/n) for n in ['2026-09-20-stage1-bootstrap-tables-r1/packet.json','2026-09-20-stage1-bootstrap-tables-review-r1/packet.json','2026-09-12-native-census-r7/baseline/build/dx86cl64','2026-09-16-stage1-1a-r2/native/baseline.image']}
def main():
