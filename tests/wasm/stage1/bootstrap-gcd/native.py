...
m.driver.SOURCE_PAIRS += [('level-1/l1-numbers.lisp','l1-fasls/l1-numbers.dx64fsl'),('level-0/l0-array.lisp','level-0/l0-array.dx64fsl'),('level-1/l1-utils.lisp','l1-fasls/l1-utils.dx64fsl'),('level-1/l1-aprims.lisp','l1-fasls/l1-aprims.dx64fsl')]
m.driver.SOURCE_PAIRS += [('level-1/l1-clos-boot.lisp','l1-fasls/l1-clos-boot.dx64fsl')]
import json
for name in json.loads((HERE.parent/'bootstrap-lexpr-spread/exclusions.json').read_text()):
    pair=(name,name.replace('level-1/','l1-fasls/').replace('.lisp','.dx64fsl'))
    if pair not in m.driver.SOURCE_PAIRS:m.driver.SOURCE_PAIRS.append(pair)
pair=('level-1/l1-error-signal.lisp','l1-fasls/l1-error-signal.dx64fsl')
if pair not in m.driver.SOURCE_PAIRS:m.driver.SOURCE_PAIRS.append(pair)
