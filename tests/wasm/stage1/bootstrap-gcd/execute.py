...
def fixture(name):
 for directory in (h,h.parent/'bootstrap-limb-division',h.parent/'bootstrap-limb-multiply',h.parent/'bootstrap-numeric-dispatch',h.parent/'bootstrap-clos-accessors',h.parent/'bootstrap-lexpr-spread'):
