...
ID='STAGE1-TERMINATION-EXCLUSION-REVIEW-R1'
SOURCES=['README.md','derive_unit.py','native-extra.lisp','run.py','packet.py']
def pins():
 prior=read(ROOT.parent/'ccl-evidence/2026-09-20-stage1-termination-exclusion-r1/source-pins.json')
 for n,h in prior.items():assert sha(ROOT/n)==h,n
 paths=[HERE/n for n in SOURCES]+[ROOT/'level-1/l1-streams.lisp']
...
def inputs(e):
 return {n:sha(e/n) for n in ['2026-09-20-stage1-termination-exclusion-r1/packet.json','2026-09-20-stage1-startup-runtime-review-r1/packet.json','2026-09-20-stage1-startup-config-r2/native-reuse.json','2026-09-20-stage1-bootstrap-heap-census-r1/packet.json','2026-09-12-native-census-r7/baseline/build/dx86cl64','2026-09-16-stage1-1a-r2/native/baseline.image']}
def main():
