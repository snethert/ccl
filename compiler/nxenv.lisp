...
(defparameter *next-nx-operators*
  (reverse
   '(()
     ...
     (%fixnum-set  #.(logior operator-single-valued-mask operator-acode-subforms-mask) t)
     (%fixnum-set-natural  #.(logior operator-single-valued-mask operator-acode-subforms-mask) natural)
     ()
     ()
