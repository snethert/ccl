...
(def-acode-rewrite acode-rewrite-ff-call (ff-call eabi-ff-call poweropen-ff-call i386-ff-call wasm-ff-call) asserted-type (address argspecs argvals resultspec &optional monitor)
