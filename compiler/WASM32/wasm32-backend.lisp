                        ...
                        (case head
                          ...
                          (t
                           (unless (or (and (member head '(car cdr)) (= n 1))
                                       ...
                                       (and (eq head '%wasm-poll) (zerop n)) (member head '(%wasm-make-restart %wasm-find-restart %wasm-invoke-restart %wasm-restart-name %wasm-svref %wasm-condition-datum %wasm-condition-expected %wasm-cell-name))
...
(defun b-condition-runtime () (concatenate 'string (b-handler-runtime) ";; Sealed bootstrap classes. Registry rows are [wrapper, ancestry mask,
