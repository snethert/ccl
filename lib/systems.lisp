...
(defparameter *ccl-system*
  '(
    ...
    #+wasm32-target (wasm-arch        "ccl:bin;wasm-arch"        ("ccl:compiler;WASM;wasm-arch.lisp"))
    ...
    #+wasm32-target (wasmenv          "ccl:bin;wasmenv"          ("ccl:lib;wasmenv.lisp"))
    ...
    #+wasm32-target (wasm-vinsns      "ccl:bin;wasm-vinsns"      ("ccl:compiler;WASM;wasm-vinsns.lisp"))
    ...
    #+wasm32-target (wasm-backend     "ccl:bin;wasm-backend"     ("ccl:compiler;WASM;wasm-backend.lisp"))
    #+wasm32-target (wasm-ffi         "ccl:bin;wasm-ffi"         ("ccl:compiler;WASM;wasm-ffi.lisp"))
    ...
    #+wasm32-target (wasm2            "ccl:bin;wasm2"            ("ccl:compiler;WASM;wasm2.lisp"))
    ...
    (xwasmfasload      "ccl:xdump;xwasm-fasload"   ("ccl:xdump;xwasmfasload.lisp"))
