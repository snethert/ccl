...
(defparameter *ccl-system*
  '(
    ...
    (wasm-arch        "ccl:bin;wasm-arch"        ("ccl:compiler;WASM;wasm-arch.lisp"))
    ...
    (wasmenv          "ccl:bin;wasmenv"          ("ccl:lib;wasmenv.lisp"))
    ...
    (wasm-vinsns      "ccl:bin;wasm-vinsns"      ("ccl:compiler;WASM;wasm-vinsns.lisp"))
    ...
    (wasm-backend     "ccl:bin;wasm-backend"     ("ccl:compiler;WASM;wasm-backend.lisp"))
    ...
    (wasm2            "ccl:bin;wasm2"            ("ccl:compiler;WASM;wasm2.lisp"))
