...
/* ABI constants — imported from generated source (see generate_abi_contract.py) */
import {
  ...
  KERNEL_STREAM_KIND_PIPE,
  KERNEL_STREAM_KIND_NAMED_RO,
  KERNEL_STREAM_KIND_FILE,
} from "./abi-constants.mjs";

export const KERNEL_ABI_VERSION = 1;

/* Re-export ABI constants for backward compatibility */
export {
  KERNEL_STATUS_PENDING,
  KERNEL_STATUS_DONE,
  KERNEL_STATUS_ERROR,
