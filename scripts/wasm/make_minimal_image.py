...
SUBTAG_SIMPLE_VECTOR = FULLTAG_NODEHEADER | (31 << NTAGBITS)
SUBTAG_U8_VECTOR = FULLTAG_IMMHEADER | (24 << NTAGBITS)
SUBTAG_SIMPLE_BASE_STRING = FULLTAG_IMMHEADER | (23 << NTAGBITS)
...
T_OFFSET = (8 - FULLTAG_NIL) + FULLTAG_MISC
